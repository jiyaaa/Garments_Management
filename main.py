...
# Entries Frame
entries_frame = Frame(root, bg="#ffcccc")
entries_frame.pack(side=TOP, fill=X)
title = Label(entries_frame, text=" Add Or Remove Employee", font=("Calibri", 18, "bold"), bg="#535c68", fg="white")
title.grid(row=0, columnspan=2, padx=10, pady=20, sticky="w")

lblName = Label(entries_frame, text="Name", font=("Calibri", 16), bg="#ffcccc", fg="black")
lblName.grid(row=1, column=0, padx=10, pady=10, sticky="w")
txtName = Entry(entries_frame, textvariable=name, font=("Calibri", 16), width=30)
txtName.grid(row=1, column=1, padx=10, pady=10, sticky="w")

lblAge = Label(entries_frame, text="Salary", font=("Calibri", 16), bg="#ffcccc", fg="black")
lblAge.grid(row=1, column=2, padx=10, pady=10, sticky="w")
txtAge = Entry(entries_frame, textvariable=age, font=("Calibri", 16), width=30)
txtAge.grid(row=1, column=3, padx=10, pady=10, sticky="w")

lbldoj = Label(entries_frame, text="Position", font=("Calibri", 16), bg="#ffcccc", fg="black")
...
lblEmail = Label(entries_frame, text="Email", font=("Calibri", 16), bg="#ffcccc", fg="black")
lblEmail.grid(row=2, column=2, padx=10, pady=10, sticky="w")
txtEmail = Entry(entries_frame, textvariable=email, font=("Calibri", 16), width=30)
txtEmail.grid(row=2, column=3, padx=10, pady=10, sticky="w")

lblGender = Label(entries_frame, text="Gender", font=("Calibri", 16), bg="#ffcccc", fg="black")
...
lblContact = Label(entries_frame, text="Contact No", font=("Calibri", 16), bg="#ffcccc", fg="black")
...
lblAddress = Label(entries_frame, text="Address", font=("Calibri", 16), bg="#ffcccc", fg="black")
...
def update_employee():
    ...
    db.update(row[0],txtName.get(), txtAge.get(), txtDoj.get(), txtEmail.get(), comboGender.get(), txtContact.get(),
              txtAddress.get(
                  1.0, END))
    messagebox.showinfo("Success", "Employee Record Update")
    clearAll()
    dispalyAll()
