...
Radiobutton(base, text="Female", padx=15, variable=vars, value=2).place(x=240, y=240)
Radiobutton(base, text="others", padx=20, variable=vars, value=3).place(x=310, y=240)
